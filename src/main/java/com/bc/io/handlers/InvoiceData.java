...
public class InvoiceData {
    ...
    public static final String USERNAME = "ldavidso";
    public static final String PASSWORD = "O3LyjW5t";
    ...
    public static void removeAllPersons() {
        ...
        String query3 = "delete from Invoices;";
        ...
        try{
            ...
            pre.executeUpdate();
            pre = conn.prepareStatement(query5);
            pre.executeUpdate();
    ...
    public static void addPerson(String personCode, String firstName, String lastName, String street, String city, String state, String zip, String country) {
        ...
        String addressQuery = "insert into Address(street,city,state,zip,country)values(\""+street+"\",\""+city+"\",\""+state+"\",\""+zip+"\",\""+country+"\");";
        String query = "insert into Person(personCode,lastName,firstName,addressId)values(\""+personCode+"\",\""+lastName+"\",\""+firstName+"\",(select from Address where street = \""+street+"\"));";

        PreparedStatement pre = null;

        try{
            pre = conn.prepareStatement(addressQuery);
            pre.executeUpdate();
            pre = conn.prepareStatement(query);
            pre.executeUpdate();
